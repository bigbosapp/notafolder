/* =========================================
   NOTA FOLDER v121.22 - MODERN ERROR POPUP
...
// Fungsi untuk memunculkan Popup Error Modern
function uiShowError(title, errorObj) {
    let msg = "Terjadi kesalahan tidak dikenal.";
    
    // Jika inputnya string biasa, langsung pakai
    ...
    // Jika inputnya Error Object dari Firebase
        ...
        switch (errorObj.code) {
            ...
            case 'auth/user-not-found':
                msg = "Akun tidak ditemukan.<br>Silakan daftar terlebih dahulu."; break;
    ...
    // Panggil Popup Modern (Merah/Danger)
...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        document.getElementById('auth-msg').innerText = ""; // Bersihkan
    }
});
...
async function loadDataFromCloud() {
    ...
    try {
        ...
        console.error(e); 
        // Error load data tidak perlu popup besar, cukup notif merah agar tidak mengganggu flow
...
window.uiShowChangelog = function() {
    const logs = ["<b>v121.22 (Modern Error)</b>: Popup Error Modern & Bahasa Indonesia.", "<b>v121.20 (UI)</b>: Update Tampilan Profil User."];
